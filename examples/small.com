...
-2 1
 N-NJ--0.269300(PDBName=N1,ResName=PLT,ResNum=821)  -1   -2.29417179    0.31272886    3.43198205 L
 C-CK--0.294100(PDBName=C10,ResName=PLT,ResNum=821) -1   -2.83462102    0.60476825    2.21070981 L
 C-CX-0.086800(PDBName=C8,ResName=PLT,ResNum=821)   -1   -2.03328699    0.47174141    1.15560071 L
 C-CY-0.161200(PDBName=C9,ResName=PLT,ResNum=821)   -1   -2.55829715    0.80008636   -0.15607460 L
 O-OZ--0.552300(PDBName=O15,ResName=PLT,ResNum=821) -1   -2.59247748   -0.39842867   -0.94937923 L
 P-P8-1.345300(PDBName=P11,ResName=PLT,ResNum=821)  -1   -2.78509051   -0.27402978   -2.54179823 L
 O-O9--0.893800(PDBName=O12,ResName=PLT,ResNum=821) -1   -3.70939484    0.85619543   -2.93459302 L
 O-O9--0.893800(PDBName=O13,ResName=PLT,ResNum=821) -1   -3.32372404   -1.44007312   -3.17623511 L
 O-O9--0.893800(PDBName=O14,ResName=PLT,ResNum=821) -1   -1.45647098    0.02522813   -3.07459986 L
 H-HI-0.033200(PDBName=H32,ResName=PLT,ResNum=821)  -1   -2.01916814    1.58514292   -0.69206752 L
 H-HI-0.033200(PDBName=H33,ResName=PLT,ResNum=821)  -1   -3.56993219    1.17766014    0.01513164 L
 H-HV-0.190700(PDBName=H34,ResName=PLT,ResNum=821)  -1   -3.86227641    0.94013697    2.29128077 L
 H-H5-0.363700(PDBName=H35,ResName=PLT,ResNum=821)  -1   -2.93442660    0.35977178    4.21332649 L
 C-CX-0.237800(PDBName=C2,ResName=PLT,ResNum=821)   -1   -1.02917631   -0.02584278    3.74480859 L
 C-CY--0.425300(PDBName=C3,ResName=PLT,ResNum=821)  -1   -0.68789233   -0.46480527    5.06696785 L
 H-H6-0.125100(PDBName=H28,ResName=PLT,ResNum=821)  -1   -0.14187008    0.39457884    5.46245652 L
 H-H6-0.125100(PDBName=H29,ResName=PLT,ResNum=821)  -1   -0.14403601   -1.40513193    4.95141541 L
 H-H6-0.125100(PDBName=H30,ResName=PLT,ResNum=821)  -1   -1.52706234   -0.72409507    5.71566398 L
 C-C7-0.447600(PDBName=C4,ResName=PLT,ResNum=821)   -1   -0.02070573   -0.05657500    2.66454303 L
 O-O9--0.659700(PDBName=O5,ResName=PLT,ResNum=821)  -1    1.16214153   -0.31989850    2.89457478 L
 C-CX--0.218600(PDBName=C6,ResName=PLT,ResNum=821)  -1   -0.63573843    0.09789891    1.32421165 L
 C-CF-0.297500(PDBName=C7,ResName=PLT,ResNum=821)   -1    0.12928469    0.02767963    0.17622594 L
 H-HV-0.187000(PDBName=H31,ResName=PLT,ResNum=821)  -1   -0.39023606    0.11356220   -0.77134926 L
 N-NG--0.366100(PDBName=N16,ResName=PLT,ResNum=821) -1    1.46224635   -0.24152250    0.11373899 L
 H-H5-0.375600(PDBName=H27,ResName=PLT,ResNum=821)  -1    1.84267883   -0.59284649    0.98583169 L
 C-CY--0.003300(PDBName=C17,ResName=PLT,ResNum=821) -1    2.51846073   -0.04821884   -1.02752269 L
 C-C7-0.858500(PDBName=C19,ResName=PLT,ResNum=821)  -1    3.48549076   -1.22161819   -0.80204107 L
 O-O9--0.804700(PDBName=O20,ResName=PLT,ResNum=821) -1    4.37143916   -1.49289924   -1.58157606 L
 O-O9--0.804700(PDBName=O21,ResName=PLT,ResNum=821) -1    3.45498030   -1.89028778    0.17401801 L
 H-HI-0.012400(PDBName=H26,ResName=PLT,ResNum=821)  -1    2.18624945   -0.15468752   -2.06300541 L
 C-CY-0.645200(PDBName=C18,ResName=PLT,ResNum=821)  -1    3.31909248    1.28851234   -0.93324706 L
 H-HI--0.053600(PDBName=H36,ResName=PLT,ResNum=821) -1    2.55864211    2.07114638   -0.87809391 L
 O-OH--0.783000(PDBName=O37,ResName=PLT,ResNum=821) -1    4.10899778    1.24525064    0.23780437 L
 H-HQ-0.457900(PDBName=H38,ResName=PLT,ResNum=821)  -1    4.07429867    2.11908625    0.66683062 L
 C-CY--0.461900(PDBName=C22,ResName=PLT,ResNum=821) -1    4.10440351    1.75273632   -2.12441961 L
 H-H6-0.089600(PDBName=H23,ResName=PLT,ResNum=821)  -1    5.11102575    1.34786079   -1.99872430 L
 H-H6-0.089600(PDBName=H24,ResName=PLT,ResNum=821)  -1    3.57435832    1.50064840   -3.04496300 L
 H-H6-0.089600(PDBName=H25,ResName=PLT,ResNum=821)  -1    4.17557377    2.84029455   -2.06549384 L

 1 2 1.5 13 1.0 14 1.5
 2 3 2.0 12 1.0
 3 4 1.0 21 1.0
