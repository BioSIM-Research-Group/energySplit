...
%NProc=4
%chk=name.chk
#p amber=softonly geom=connectivity

molUP VMD is a very good plugin :)

-1 1
 C-CY-0.645200(PDBName=C18,ResName=PLT,ResNum=821)           -1     3.319092   1.288512  -0.933247 L 
 H-HI--0.053600(PDBName=H36,ResName=PLT,ResNum=821)          -1     2.558642   2.071146  -0.878094 L 
 O-OH--0.783000(PDBName=O37,ResName=PLT,ResNum=821)          -1     4.108998   1.245251   0.237804 L 
 H-HQ-0.457900(PDBName=H38,ResName=PLT,ResNum=821)           -1     4.074299   2.119086   0.666831 L 
 C-CY--0.461900(PDBName=C22,ResName=PLT,ResNum=821)          -1     4.104404   1.752736  -2.124420 L 
 H-H6-0.089600(PDBName=H23,ResName=PLT,ResNum=821)           -1     5.111026   1.347861  -1.998724 L 
 H-H6-0.089600(PDBName=H24,ResName=PLT,ResNum=821)           -1     3.574358   1.500648  -3.044963 L 
 H-H6-0.089600(PDBName=H25,ResName=PLT,ResNum=821)           -1     4.175574   2.840295  -2.065494 L 
